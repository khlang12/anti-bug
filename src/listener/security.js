...
let htmlFilePath;
let htmlContent;
async function securityListener(context, data) {
    ...
    switch (data.type) {
        ...
        case "auditreport": {
            ...
            if (auditreportPanel) {
                ...
                auditreportPanel = vscode.window.createWebviewPanel('auditreportView', 'Audit Report View', vscode.ViewColumn.Two, { enableScripts: true });
                try {
...
exports.default = securityListener;
